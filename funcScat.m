...
a1=6.5;		% Stands for alpha1
a2=8;		% Stands for alpha2
b1=a1/sqrt(3);	% Stands for beta1
b2=a2/sqrt(3);  % Stands for beta2
r1=2800;	% Stands for rho1
r2=3200;	% Stands for rho2
