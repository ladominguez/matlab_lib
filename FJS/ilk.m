...
% of the errror as a function of the abscissa and the allowable order. 
%
% SEE ALSO: 
%
...
% Last modified by fjsimons-at-alum.mit.edu, 05/17/2010
...
if ~isstr(lemma)
  ...
  switch lemma
   case 1
    ...
    % the orders are one apart. Not that we verify this for Schmidts instead.
