...
c
c	BEGIN DRLA 
c	These lines set P phase instead of asking to the user
	no=2
	phlst(1)='P'
	phlst(2)=' '
	GO TO 38
...
c	DRLA I commented the next 1 line
c      if(.not.fnd) print *,'Brnset:  phase ',phlst(i),' not found.'
      go to 10
c
...
c     1 'been selected -'
      fnd=.true.
c	DRLA I commented the next two lines
