...
% GETTCROSS:This program plot the seismograms of n stations and save 
...
[Filter Signal]=SelectWin(Station);
	...
	for ii=1:NumFiles
	    ...
	    [Dummy PTime]=max(Corr(round(Theory*Fs)-WinSize:round(Theory*Fs)+WinSize));
	    PTime=PTime+round(Theory*Fs)-WinSize;	
	    PTime=t(PTime);	
