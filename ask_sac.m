...
% Detects S wave using a modified version of the LTA/STA algoritm. In this
% case the LTA window is fixed at the beginnin of the record (noise level).
% And STA slides along the record.

%% Initial Variables
addpath('/home/antonio/CJA_Msac1.1/process/');
LTA_w     = 3.0; % Width in seconds
